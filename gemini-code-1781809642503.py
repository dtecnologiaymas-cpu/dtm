...
<body>
    ...
    <nav class="navbar">
        <div class="container">
            <div class="logo">
                <img src="descarga.png" alt="DTecnologíaYMás Logo" class="logo-img">
                <div class="logo-text">
            ...
            <div class="nav-right">
                <button class="theme-toggle" id="theme-toggle" title="Cambiar modo">
                    ...
                    <div class="contact-info-list">
                        <div class="contact-info-item">
                            ...
                            <div>
                                ...
                                <p style="color: #cbd5e1;">245 102 2162</p>
                            </div>
                        </div>
                        <div class="contact-info-item">
                            ...
                            <div>
                                ...
                                <p style="color: #cbd5e1;">Manuel M. Flores 3318, Santa Cruz, Colonia 3 de mayo, 75520 Cdad. Serdán, Pue., México</p>
                            </div>
                        </div>
                        <div class="contact-info-item">
                            ...
                            <div>
                                ...
                                <p style="color: #cbd5e1;">9:00 AM a 9:00 PM<br>De Lunes a Sábado</p>
                            </div>
                        </div>
                    </div>
                </div>
...
print("File index-v3.html generated successfully.")